...
public class GLES20Canvas implements GLESCanvas {
    ...
    protected abstract static class ShaderParameter {
        public int handle;
    ...
    private int assembleProgram(int vertexShader, int fragmentShader, ShaderParameter[] params) {
        ...
        if (mLinkStatus[0] != GLES20.GL_TRUE) {
            MLog.e(TAG, "Could not link program: ");
            MLog.e(TAG, GLES20.glGetProgramInfoLog(program));
    ...
    public void beginRenderTarget(RawTexture texture) {
        save(); // saveFreePuzzlePic matrix and alpha and blending

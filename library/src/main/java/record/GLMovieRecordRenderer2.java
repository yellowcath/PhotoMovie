...
public class GLMovieRecordRenderer2 extends MovieRenderer<GLESCanvas>{

    private Context mContext;
    public GLMovieRecordRenderer2(Context context) {
        super();
        mContext = context;
    }
    ...
    public void testEncodeVideoToMp4() {
        ...
        try {
            ...
            mPainter.setSize(mWidth, mHeight);
            setMovieViewport(0, 0, mWidth, mHeight);
            ...
            for (int i = 0; i < NUM_FRAMES; i++) {
                ...
                mElapsedTime = (int) (i * (1000f/FRAME_RATE));
